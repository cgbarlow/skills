---
name: ir3-tax-return
description: File a New Zealand individual IR3 income tax return for the 2026 tax year (1 April 2025 – 31 March 2026) by driving the official Inland Revenue myIR portal at https://myir.ird.govt.nz/ in the browser. Use this skill whenever the user mentions an IR3, NZ tax return, IRD return, "doing my taxes" / "filing my taxes" in a New Zealand context, filing with Inland Revenue, residual income tax, IETC, PIE tax adjustment, ACC earners' levy, schedular payments, provisional tax, or asks for help completing their NZ personal income tax. Use it even if the user does not say "IR3" by name. The skill is browser-driven: it pauses for the user to authenticate via RealMe, navigates Income tax → Returns and transactions → File return, fills each section using IRD's pre-populated data, prompts the user inline only for fields that are genuinely missing or need a human judgement call, and refuses to click final Submit without an explicit, fresh "yes submit" from the user. It is grounded in the official IR3G (March 2026) guide bundled at references/IR3G-2026.txt.
